...
UINT CModelData::ExportPAK_T(CStdioFile* file,CPakExpOpt *peo)
{
...
UINT CModelData::ExportPAKT_Elements(CStdioFile* file,UINT *uNGELEM,CPakExpOpt *peo)
{
	CString str;
	UINT i,j,k,z;
	HProperties pr;
...
//**************************************************************************
UINT CModelData::ExportPAKT_Elements_Without_Groups(CStdioFile* file,UINT *uNGELEM,CPakExpOpt *peo)
{
	CString str;
	UINT i,j,k,z;
	HProperties pr;
...
UINT CModelData::ExportPAKT_Nodes(CStdioFile* file)
{
...
UINT CModelData::ExportPAKT_MatModels(CStdioFile* file)
{
...
UINT CModelData::ExportPAKT_TimeFunctions(CStdioFile* file)
{
	CString str;
	CPAKString pstr;
	UINT i,j,uMAXTFT=0;
...
UINT CModelData::ExportPAKT_PrescTemp(CStdioFile* file)
{
	HLoads lo;
	UINT i;
	CString str;
...
/*
UINT CModelData::ExportPAKT_Loads(CStdioFile* file)
{
	CString str;
	UINT i,j,uMAXTFT=0;
	HLoads lo;
